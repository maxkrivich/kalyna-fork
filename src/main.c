...
#define lu(var) ((unsigned long)(var))
...
int main(int argc, char** argv) {
        ...
        printf("\n=============\n");
        printf("Kalyna (%lu, %lu)\n", lu(ctx22_e->nb * 64), lu(ctx22_e->nk * 64));
        ...
        printf("\n=============\n");
        printf("Kalyna (%lu, %lu)\n", lu(ctx22_d->nb * 64), lu(ctx22_d->nk * 64));
        ...
        printf("\n=============\n");
        printf("Kalyna (%lu, %lu)\n", lu(ctx24_e->nb * 64), lu(ctx24_e->nk * 64));
        ...
        printf("\n=============\n");
        printf("Kalyna (%lu, %lu)\n", lu(ctx24_d->nb * 64), lu(ctx24_d->nk * 64));
        ...
        printf("\n=============\n");
        printf("Kalyna (%lu, %lu)\n", lu(ctx44_e->nb * 64), lu(ctx44_e->nk * 64));
        ...
        printf("\n=============\n");
        printf("Kalyna (%lu, %lu)\n", lu(ctx44_d->nb * 64), lu(ctx44_d->nk * 64));
        ...
        printf("\n=============\n");
        printf("Kalyna (%lu, %lu)\n", lu(ctx48_e->nb * 64), lu(ctx48_e->nk * 64));
        ...
        printf("\n=============\n");
        printf("Kalyna (%lu, %lu)\n", lu(ctx48_d->nb * 64), lu(ctx48_d->nk * 64));
        ...
        printf("\n=============\n");
        printf("Kalyna (%lu, %lu)\n", lu(ctx88_e->nb * 64), lu(ctx88_e->nk * 64));
        ...
        printf("\n=============\n");
        printf("Kalyna (%lu, %lu)\n", lu(ctx88_d->nb * 64), lu(ctx88_d->nk * 64));
